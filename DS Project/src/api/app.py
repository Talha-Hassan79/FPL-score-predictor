# src/api/app.py
"""FastAPI backend exposing player data and forecasts.
The heavy lifting (data loading, model training) is delegated to
`predictor.py` which is UI‑agnostic.
"""
...
# Serve static files (frontend) from the "frontend" directory under src
